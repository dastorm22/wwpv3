...
@section('content')
    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                <form action="{{ action('AnalysisController@ofert_upload') }}" method="POST" enctype="multipart/form-data" class="form-horizontal" role="form">
                {{ csrf_field() }}
                ...
                <!-- Page-Title -->
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <h4 class="page-title">New Load Offer</h4>
                            <p class="text-muted page-title-alt">Upload a file to explore pricing against all providers.</p>
                        </div>
                    </div>
                            ...
                            @component('partials.components.card-box')
                                ...
                                <div class="row m-t-40">
                                    <div class="col-md-12">
                                        ...
                                        @component('partials.components.form-group-horizontal')
                                            @slot('label', 'Main Offer Only')
                                            @include('partials.forms.switch', [
                                                'name'=>'is_only_main',
                                                'label' => 'Only compare against the main Offer.'
                                            ])
                                        @endcomponent
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        @component('partials.components.form-group-horizontal')
                                            ...
                                            @include('partials.forms.select-array', [
                                                ...
                                                'options' => $columns,
                                                'selected' => $source->column_description,
                                                ])
                                        @endcomponent
